...
const JSTAR_URL = 'https://raw.githubusercontent.com/alex8875/m3u/refs/heads/main/jstar.m3u';
...
app.get('/playlist.m3u8', async (req,res) => {
  try {
    ...
    // --- Append external JStar M3U (preserve groups) ---
    try {
      ...
      console.error('Error fetching external JStar M3U', e && e.message);
    }
    ...
    m3u += `https://raw.githubusercontent.com/alex8875/m3u/refs/heads/main/jstar.m3u\n`;
    m3u += '\n# -------- END CUSTOM --------\n';
